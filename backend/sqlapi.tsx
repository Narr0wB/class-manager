...
export const SQL_QUERY_INSERT_PRE = 1;
export const SQL_QUERY_FETCH_PRE = 2;
...
export const queries_strings: { [id: number] : string } = {
    [SQL_QUERY_INSERT_PRE]: "INSERT INTO AM_Prenotazioni(id_utente, id_aula, data_ora_pre, approvazione_pre) VALUES (?, ?, ?, ?)",
    [SQL_QUERY_FETCH_PRE]: "SELECT * FROM AM_Prenotazioni WHERE",
